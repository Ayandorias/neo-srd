...
Grundprinzip
Illusionsmagie ermöglicht die Manipulation der sensorischen Wahrnehmung. Die erschaffenen Konstrukte besitzen keine physische Masse und verursachen keinen direkten physischen Schaden. Sie dienen ausschließlich der Täuschung, Desorientierung und psychologischen Manipulation.
Gegenwehr
...
Grundprinzip
Traummagie definiert sich als die Manipulation des Unbewussten. Der Arkanist löst sich von der physischen Realität, um in die Welt der schlafenden Geister einzudringen, dort Geheimnisse zu lüften oder den Verstand durch falsche Visionen zu manipulieren.
Gegenwehr
...
Domäne: Form | Basisattribut: WIL | Stufe: 4 | Trainingsstufe: 4
Grundprinzip
Verwandlungsmagie ermöglicht die grundlegende anatomische Veränderung von Lebewesen und physischer Materie. Der Arkanist ist nicht an sein ursprüngliches Gefäß gebunden und vermag es, die eigene Anatomie drastisch zu wandeln oder fremde Substanzen neu zu formen.
Gegenwehr
...
Grundprinzip
Beherrschungsmagie zielt auf die mentale Kontrolle über fremde Lebewesen ab. Der freie Wille des Ziels wird durch arkane Zwänge gebrochen, um es zu Handlungen zu zwingen, die es aus eigenen Stücken niemals tun würde. In vielen zivilisierten Kulturen gilt diese Disziplin als absolutes Tabu.
...
**Grundprinzip**
Seelenmagie manipuliert direkt den metaphysischen Lebensfunken eines Lebewesens. Sie greift tiefer als reine Gedankenkontrolle ein, um Erinnerungen zu verändern, die Persönlichkeit zu verschieben oder die Essenz des Ziels zu beschädigen. 
...
**Grundprinzip**
Telepathie ermöglicht die lautlose Kommunikation und das Lesen fremder Gedankenströme über beliebige Distanzen. Sie hinterlässt keine physischen oder hörbaren Spuren und eignet sich daher ideal für Infiltration und Spionage.
...
== Chi-Magie
#action("Basisattribut:", "TBD")

**Grundprinzip**
Chi-Magie definiert sich als die interne Kanalisierung der eigenen Lebensenergie zur temporären Steigerung körperlicher und geistiger Attribute. Eine Manipulation der Umwelt oder anderer Personen ist ausgeschlossen; die Wirkung entfaltet sich ausschließlich im eigenen Gefäß.
...
**Grundprinzip**
Heilmagie ermöglicht das arkane Schließen von Wunden. Sie heilt ausschließlich physische Substanzverletzungen (Schaden) und kritische Systemausfälle (Trauma). Körperliche Ermüdung (ERM) lässt sich auf diesem Wege nicht regenerieren.
...
**Grundprinzip**
Naturmagie ermöglicht die Interaktion und Kontrolle über Flora, Fauna und organische Ökosysteme. Der Arkanist tritt in direkte Resonanz mit dem Lebensfluss der natürlichen Welt, anstatt diese durch rohe Gewalt zu manipulieren.
...
**Grundprinzip**
Dimensionale Magie ermöglicht die direkte Manipulation von Raum und Zeit sowie die Öffnung von Portalen im geometrischen Gefüge der Realität. Da diese Magie die kosmische Ordnung verzerrt, erfordert sie ein makelloses arkantes Verständnis.
...
**Grundprinzip**
Runenmagie dient der Bindung flüchtiger arkaner Energie in dauerhafte materielle Träger wie Stein, Stahl oder Fleisch. Anstatt einen Zauber nur für den Augenblick zu wirken, werden mystische Codes und komplexe Glyphen in feste Materie graviert, um als stetige Ankerpunkte zu dienen.
...
**Grundprinzip**
Schutzmagie fokussiert sich auf die Konstruktion defensiver Barrieren und Schutzkreise gegen kinetische, arkane und umweltbedingte Angriffe. Sie bildet das wichtigste Werkzeug, um in den gnadenlosen Gefechten der mechanischen Welt zu überleben.
...
Um den Einsatzwert für die Arkane Formel zu errechnen, wird folgende Formel genutzt.
#block(
  width: 100%,
  height: 60pt,
  stroke: 1pt + amber.at("600"),
...
*5. Blutmagie (Notfall):* \ 
Ein Arkanist kann auch über seine #neo.gls-short("gem") hinaus arkane Formeln wirken. Dies hat allerdings zur Folge, dass die benötigte Kraft direkt aus seiner Lebensenergie gezogen wird. Nach dem die Formel gewirkt wurde, bricht der Arkanist bewusstlos zusammen.

=== Regeneration
Die Regeneration folgt den gleichen Regeln wie es im Kapitel Kampf beschrieben ist.

== Erschließung neuer Domänen / Fokusse
Das erlernen neuer Fokusse aus einer anderen Domäne erfordert, dass der Arkanist sich entlang des Pentagrammes weiter entwickelt. 
...
#align(center)[
  #cetz.canvas({
    ...
    // 1. Der äußere Ring (Konträre / Gesperrte Domänen)
    // Dargestellt als feine, gestrichelte Linien, die nicht direkt überschritten werden können.
    line(pos-geist, pos-form, pos-leben, pos-elementar, pos-struktur,
         close: true, stroke: (paint: luma(150), dash: "dashed", thickness: 1pt))

    // 2. Das magische Pentagramm (Befreundete Domänen / Die Brücken)
    // Die dicken Linien zeigen den Fluss der Energie: Struktur <-> Form <-> Elementar <-> Leben <-> Geist
...
*Die Brücke:* \
 Um eine gesperrte Domäne zu aktivieren, muss der Arkanist zwingend eine angrenzende,befreundete Domäne als Brücke nutzen.

*Die Voraussetzung:* \
Um zur nächsten Domöne vorzudringen muss ein Fokus aus der neuen Domäne aktiviert werden.

*Die Erschließung:* \
Wenn die Vorraussetzungen erfüllt sind, können aus der gesperrten Domöne Fokusse aktiviert werden.
...
=== Anhaltender Schaden
Die Resonanz Dauer erhöht nicht den anfänglichen Schadensausstoß, sondern bestimmt, wie lange das Opfer der Formel ausgesetzt ist.
Ist die Dauer der Formel länger als eine Spielrunde, so erleidet das Opfer fortlaufenden Schaden. Die Höhe des fortlaufenden Schadens wird jedesmal erneut ausgewürfelt.